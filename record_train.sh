...
./scripts/run_scenic.sh debris.scenic $NUM_SCENARIOS debris_avoidance_recordings $SCENARIO_MAX_TIME $SCENIC_SEED
echo "Running Scenic for $NUM_SCENARIOS Oncoming scenarios"
./scripts/run_scenic.sh oncoming_car.scenic $NUM_SCENARIOS oncoming_car_recordings $SCENARIO_MAX_TIME $SCENIC_SEED
