...
def spawn(client, world, number_of_vehicles, number_of_walkers=0, safe=False):
    ...
    try:
        ...
        if safe:  # avoid spawning vehicles prone to accidents
            blueprints = [
        ...
        return vehicles_list, walkers_list, all_actors
    except Exception as e:
        print(e)


def destroy(client, vehicles_list, walkers_list, all_actors):
