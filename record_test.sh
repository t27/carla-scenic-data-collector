...
./scripts/run_scenic.sh tarang_test_debris.scenic $NUM_SCENARIOS test_debris_avoidance_recordings $SCENARIO_MAX_TIME $SCENIC_SEED
echo "Running Scenic for $NUM_SCENARIOS Debris avoidance scenarios"
./scripts/run_scenic.sh tarang_test_opposing_car.scenic $NUM_SCENARIOS test_oncoming_car_recordings $SCENARIO_MAX_TIME $SCENIC_SEED
